...
<# Begin: DataSource "exchange-on-premises-usermailbox-manage-in-place-archive | Exchange-On-Premises-Get-Usermailbox-Wildcard-Name-Alias" #>
$tmpPsScript = @'
...
'@ 
$tmpModel = @'
[{"key":"ExchangeGuid","type":0},{"key":"SamAccountName","type":0},{"key":"UserPrincipalName","type":0},{"key":"DistinguishedName","type":0},{"key":"PrimarySmtpAddress","type":0},{"key":"DisplayName","type":0},{"key":"Identity","type":0},{"key":"ArchiveStatus","type":0},{"key":"ArchiveGuid","type":0}]
'@ 
$tmpInput = @'
...
exchange-on-premises-usermailbox-manage-in-place-archive | Exchange-On-Premises-Get-Usermailbox-Wildcard-Name-Alias
'@ 
...
<# End: DataSource "exchange-on-premises-usermailbox-manage-in-place-archive | Exchange-On-Premises-Get-Usermailbox-Wildcard-Name-Alias" #>

<# Begin: DataSource "exchange-on-premises-usermailbox-manage-in-place-archive | Exchange-On-Premises-Get-Usermailbox-In-Place-Archive-Status" #>
$tmpPsScript = @'
$enabled = $false
...
exchange-on-premises-usermailbox-manage-in-place-archive | Exchange-On-Premises-Get-Usermailbox-In-Place-Archive-Status
'@ 
...
<# End: DataSource "exchange-on-premises-usermailbox-manage-in-place-archive | Exchange-On-Premises-Get-Usermailbox-In-Place-Archive-Status" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "Exchange On-Premises - Usermailbox - Manage In-Place Archive" #>
$tmpSchema = @"
[{"label":"Search","fields":[{"key":"searchMailbox","templateOptions":{"label":"Search MailBox","required":true},"type":"input","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false},{"key":"selectedMailbox","templateOptions":{"label":"Select Mailbox","required":true,"grid":{"columns":[{"headerName":"Display Name","field":"DisplayName"},{"headerName":"Primary Smtp Address","field":"PrimarySmtpAddress"},{"headerName":"User Principal Name","field":"UserPrincipalName"},{"headerName":"Archive Status","field":"ArchiveStatus"}],"height":300,"rowSelection":"single"},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_0","input":{"propertyInputs":[{"propertyName":"searchValue","otherFieldValue":{"otherFieldKey":"searchMailbox"}}]}},"useDefault":false,"allowCsvDownload":true},"type":"grid","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":true},{"key":"checkboxArchive","templateOptions":{"label":"In-Place Archive","useSwitch":true,"checkboxLabel":"Yes","useDataSource":true,"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_1","input":{"propertyInputs":[{"propertyName":"selectedMailbox","otherFieldValue":{"otherFieldKey":"selectedMailbox"}}]}},"displayField":"enabled"},"type":"boolean","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false}]}]
"@ 

$dynamicFormGuid = [PSCustomObject]@{} 
$dynamicFormName = @'
Exchange On-Premises - Usermailbox - Manage In-Place Archive
'@ 
